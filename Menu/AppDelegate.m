...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //初始化主视图及左右菜单视图
    leftViewController *leftViewController1=[[leftViewController alloc] init];
    midViewController *midViewController2=[[midViewController alloc] init];
    rightViewController *rightViewController3=[[rightViewController alloc] init];
